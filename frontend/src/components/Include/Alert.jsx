...
const Alert = ({ type, message, close,children }) => {
    ...
    if (type == 'error') {
        alert = (<div className={`mb-5 text-center bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative`} role="alert">
        ...
        alert = (<div className={`mb-5 text-center bg-blue-100 border border-blue-400 text-blue-700 px-4 py-3 rounded relative`} role="alert">
        ...
        alert = (<div className={`bg-orange-100 border border-orange-400 text-orange-700 px-4 py-3 rounded relative mb-5 text-center`} role="alert">
